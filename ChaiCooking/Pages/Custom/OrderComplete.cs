...
{
    public class OrderComplete : Page
    {
        ...
        public OrderComplete()
        {
            ...
            //this.Id = (int)AppSettings.PageNames.OrderComplete;
            ...
            Title = new Layouts.Custom.PageTitle("Order Complete", Color.White, Color.Black);
            ...
            //NextButton.UpAction = new Models.Action((int)Actions.ActionName.GoToPage, (int)AppSettings.PageNames.PhotoMeal);
