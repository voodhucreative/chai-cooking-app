...
{
    public class DeliveryAddressConfirmation : Page
    {
        ...
        public DeliveryAddressConfirmation()
        {
            this.IsScrollable = true;
            this.FullScreen = true;
            //this.Id = (int)AppSettings.PageNames.DeliveryAddressConfirmation;
            ...
            Title = new Layouts.Custom.PageTitle("Delivery Address Confirmation", Color.White, Color.Black);
