...
namespace TechExpo.Pages
{
    public class OrderConfirmation : Page
    {
        ...
        public OrderConfirmation()
        {
            ...
            //this.Id = (int)AppSettings.PageNames.OrderConfirmation;
            ...
            Title = new Layouts.Custom.PageTitle("Order Confirmation", Color.White, Color.Black);
            ...
            //NextButton.UpAction = new Models.Action((int)Actions.ActionName.GoToPage, (int)AppSettings.PageNames.OrderComplete);
