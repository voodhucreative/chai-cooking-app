...
{
    public class CookItCornerSectionTile : StandardLayout
    {
        ...
        public CookItCornerSectionTile(CookItCornerSection section)//string title, string info, string imageSource)
        {

            ComponentInfo = section.ComponentInfo;
            ...
            Title = new StaticLabel(section.Name);
            ...
            BackgroundImage = new StaticImage(section.ImageSource, Units.ScreenWidth, null);
